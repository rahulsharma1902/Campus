@extends('Public.index')
 ...
 <style type="text/css">
  ...
  <!-- <body class="body"> -->
      ...
      <!-- <section id="hero">
          <div id="heroCarousel" data-bs-interval="5000" class="carousel slide carousel-fade" data-bs-ride="carousel">
              ...
              <div class="carousel-inner" role="listbox"> -->
                  <!-- Slide 1 images -->
                  <!-- <div class="carousel-item active" style="background: url('{{asset('products_images')}}/{{$college_page['images']}}')"> -->
                      <!-- <div class="carousel-container">
                          <div class="container">
                              ...
                              <p class="animated fadeInUp">Ut velit est quam dolor ad a aliquid qui aliquid. Sequi ea ut
                                  ...
                                  ea voluptatem. Esse doloremque accusamus repellendus deleniti vel. Minus et tempore
                                  modi architecto.</p> <a href="#about"
      ...
      <section id="hero">
      <main id="main">
          <section id="cta" class="cta" style="background: linear-gradient(rgba(12, 13, 14, 0.8), rgba(12, 13, 14, 0.8)), url('{{asset('products_images')}}/{{$college_page['images']}}') fixed center center; !important background-repeat: no-repeat !important; background-size: cover !important;">
              
          <div class="container">
                  <div class="text-center">
                      <h3 class="text-light">{{$college_page['college_name'] ?? ''}}</h3>
                      <p class="text-light"> Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla
                          pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt
                          mollit anim id est laborum.</p>
                           <!-- <a class="cta-btn" data-id="{{$college_page['id'] ?? ''}}" href="#">JOIN PAGE</a> -->
                  </div>
              </div>
                  ...
                  <div class="row justify-content-center">
                      <div class="col-xl-10">
                          <div class="row">
                              ...
                              <div class="col-lg-6">
                                <!-- <div class="map"></div> -->
                                <iframe width="600" height="450" frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/place?q={{$college_page['location']}}&key=AIzaSyD1RAgEeGApXi7twfygIEpARWGsddgys3g" allowfullscreen></iframe>
                              </div>
                              <!-- <script>
                            ...
                            <!-- <script
                                src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAARQsQLsJM2S85cr60Eam3AaaYF98VBpU&callback=initMap&v=weekly"
                                defer
                                >
                            </script> -->
      ...
      <!-- <button class="trycode btn btn-danger">Try Code</button> -->
      <!-- ======= Footer ======= -->
      <footer id="footer">
